...
@section('title', 'Nova Nota Adesiva')

@section('content')
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="task-card color-1" style="padding: 30px;">
            <div class="text-center mb-4">
                <i class="fas fa-sticky-note" style="font-size: 60px; color: #667eea;"></i>
                <h2 class="mt-3">Criar Nova Nota Adesiva</h2>
                <p class="text-muted">Escreva sua tarefa com estilo!</p>
            </div>
            ...
            <form action="{{ route('tasks.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           name="titulo" 
                           value="{{ old('titulo') }}"
                           placeholder="Ex: Comprar presentes de Natal"
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('descricao') is-invalid @enderror" 
                              ...
                              name="descricao" 
                              rows="5"
                              placeholder="Detalhes da sua tarefa..."
                              style="border-radius: 15px; padding: 12px;">{{ old('descricao') }}</textarea>
                    @error('descricao')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
